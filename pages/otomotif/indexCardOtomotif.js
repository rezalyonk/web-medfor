...
import styles from "./indexCardOtomotif.module.css";

export default function IndexCardOtomotif() {
    ...
    async function fetchData() {
      try {
        ...
        const filteredPosts = data.posts.filter(
          (post) => post.primary_tag && post.primary_tag.name === "Otomotif"
        );
  ...
  return (
    <>
      ...
      {/* <h1>ini card tampilan otomotif </h1> */}
    </>
  );
}
