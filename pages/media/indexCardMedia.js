...
import styles from "./indexCardMedia.module.css";
import { fetchDataAllPost } from "@/pages/api/ghostConfig";

export default function IndexCardMedia() {
    ...
    async function fetchData() {
      try {
        ...
        const filteredPosts = data.posts.filter(
          (post) => post.primary_tag && post.primary_tag.name === "Media"
        );
